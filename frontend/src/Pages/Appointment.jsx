...
const Appointment = () => {
    ...
    const fetchDocInfo = async () => {
        const docInfo = doctors.find((doc) => doc.doctorID === docId)
    ...
    const bookAppointment = async () => {
        ...
        try {
            ...
            let payload = { 
                "DoctorID": docId,  // This should be DoctorID to match the backend
                "SlotDate": slotDate, 
                "SlotTime": slotTime 
            };
            ...
            const { data } = await axios.post(backendUrl + '/api/UserApi/book-appointment',payload , { headers: { Authorization: `Bearer ${token}` } })
            console.log(data);
