    ...
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.statistics.doctorCount}</p>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.statistics.appointmentCount}</p>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.statistics.userCount}</p>
      ...
      <div className='bg-white'>
        ...
        <div className='pt-4 border border-t-0'>
          {dashData.appointmentDTOs.slice(0, 5).map((item, index) => (
